...
class CustomBertClassifier(nn.Module):
    def __init__(self, hidden_dim= 200, bert_dim_size=768, num_of_output=6, lstm_hidden = 200,proj_size=50, model_name = "bert-base-uncased"):
        ...
        self.lstm = nn.LSTM(input_size=bert_dim_size, hidden_size=lstm_hidden, num_layers=3, batch_first=False, dropout=0.2, bidirectional=True, proj_size=proj_size)
    def forward(self, sentences, citation_idxs, mask, device="mps"):
        ...
        concat_tokens = torch.nn.Flatten(lstm_output)
