...
class CustomBertClassifier(nn.Module):
    def __init__(self, hidden_dim= 50, bert_dim_size=768, num_of_output=6, lstm_hidden = 120,proj_size=100, model_name = "bert-base-uncased"):
        """
        """
        ...
        encoder_layer = nn.TransformerEncoderLayer(d_model=lstm_hidden, nhead=8, dim_feedforward=512, dropout=0.2, batch_first=True)
