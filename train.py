...
optimizer = torch.optim.Adam(network.parameters(), weight_decay = 5e-5, lr=0.001)
# optimizer = torch.optim.Adam(network.parameters(), lr=0.01)
scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, 'max', patience = 2, factor = 0.6, verbose = True)
n_epochs = 60
class_factor = 0.4
